...
| **DraftKings** (NFL classic) | $50,000 salary | 1 QB, 2 RB, 3 WR, 1 TE, 1 FLEX, 1 DST | — | — |
| **FanDuel** | $60,000 salary | varies by sport | — | — |
| **DraftKings** (NBA) | $50,000 salary | PG, SG, SF, PF, C, G, F, UTIL — slots with overlapping eligibility | — | — |
